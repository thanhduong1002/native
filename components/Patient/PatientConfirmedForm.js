...
const PatientConfirmedForm = ({ navigation }) => {
    return (
        <ScrollView style={{ backgroundColor: 'white' }}>
            <View style={{flex:1, height:340, borderTopLeftRadius: 0, borderTopRightRadius: 0, borderBottomLeftRadius: 45, borderBottomRightRadius: 45, backgroundColor: '#00C7C7',justifyContent:'center', alignItems:'center'}}>
                ...
                <Text style={{fontSize:25, color:'white'}}>Lịch khám của bạn đã được gửi đi.</Text>
                <Text style={{fontSize:25, color:'white'}}>Bạn sẽ nhận được thông báo khi lịch khám được xác nhận.</Text>
            </View>
...
export default PatientConfirmedForm;
